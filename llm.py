...
["input" is "What are the total seats of dunki in pune ?",
"SQLQuery" is "SELECT sum(total_seats) from movie_occupancy_6_months_table_1 where movie_name='Dunki' and city_name='Pune' "
...
def create_agent():
	...
	open_ai_api_key = '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'
    ...
    "is about movie data, like 'how many top performing cities are there?' or 'total occupied seats in top 5 cities'"
	)
